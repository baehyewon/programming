...
import com.my.taste.dap.FriendListViewAdapter4;
...
public class Main4Activity extends Activity implements View.OnClickListener{
    private String LOG_TAG = "Main4Activity";
    ...
    private FriendListViewAdapter4 mFriendListAdapter = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtResult.setText("" +Nickname + "님의 완료업무");
        ...
        mListView.setOnItemClickListener( new Main4Activity.ListViewItemClickListener() );
        mListView.setOnItemLongClickListener(new Main4Activity.ListViewItemLongClickListener());
    ...
    public void updateListView()
    {
        ...
        mFriendListAdapter = new FriendListViewAdapter4(this, mFriendArrayList);
        ...
        for(int i=0; i<mFriendList.size(); i++) {
            ...
            if(mFriendList.get(i).getIsFinish().equals("T")&& mFriendList.get(i).getIsFinish_2().equals("T")){
        ...
        alt_bld.setCancelable(false)
                .setPositiveButton("네", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        AlarmUtil.unregisterAlarm(Main4Activity.this, mSelAlarmId);
                        updateListView();
                        mSelItem = null;
                    }
                })
