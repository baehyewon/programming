...
import com.my.taste.dap.FriendListViewAdapter55;
...
public class Main55Activity extends Activity implements View.OnClickListener{
    ...
    private FriendListViewAdapter55 mFriendListAdapter = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtResult.setText("" +Nickname + "님의 중요업무");
        ...
        mListView.setOnItemClickListener( new Main55Activity.ListViewItemClickListener() );
        mListView.setOnItemLongClickListener(new Main55Activity.ListViewItemLongClickListener());
    ...
    public void updateListView()
    {
        ...
        for(int i=0; i<mFriendList.size(); i++) {
            ...
            if(mFriendList.get(i).getIsHoney().equals("T")) {
        ...
        mFriendListAdapter = new FriendListViewAdapter55(this, mFriendArrayList);
        ...
        alt_bld.setCancelable(false)
                .setPositiveButton("네", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        AlarmUtil.unregisterAlarm(Main55Activity.this, mSelAlarmId);
                        updateListView();
                        mSelItem = null;
                    }
                })
