...
import com.my.taste.dap.FriendListViewAdapter88;
...
public class Main88Activity extends Activity implements View.OnClickListener{

    private String LOG_TAG = "Main88Activity";
    ...
    private FriendListViewAdapter88 mFriendListAdapter = null;
...
*/
        btnSearch = findViewById(R.id.btn_search_2);
        btnSearch.setOnClickListener(this);


        //스크롤뷰뷰
        mScrollView = (ScrollView) findViewById(R.id.am3_scroll);
        mListView = (ListView)findViewById(R.id.am3_listview);
        mListView.setOnItemClickListener( new Main88Activity.ListViewItemClickListener() );
        mListView.setOnItemLongClickListener(new Main88Activity.ListViewItemLongClickListener());
...
//                        startApplication();
    ...
    public void updateListView()
    {
        ...
        mFriendListAdapter = new FriendListViewAdapter88(this, mFriendArrayList);
        ...
        for(int i=0; i<mFriendList.size(); i++) {
           ...
           // compare1 = today1.compareTo(mFriendList.get(i).getBirthday());
            ...
            if(mFriendList.get(i).getName().contains(search)){
        ...
        alt_bld.setCancelable(false)
                .setPositiveButton("네", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        AlarmUtil.unregisterAlarm(Main88Activity.this, mSelAlarmId);
                        updateListView();
                        mSelItem = null;
                    }
                })
