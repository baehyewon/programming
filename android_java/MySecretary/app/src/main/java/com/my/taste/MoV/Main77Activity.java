...
import com.my.taste.dap.FriendListViewAdapter77;
...
public class Main77Activity extends Activity implements View.OnClickListener{
    private String LOG_TAG = "Main77Activity";
    ...
    private FriendListViewAdapter77 mFriendListAdapter = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtResult.setText("" +Nickname + "님의 오늘업무");
        ...
        mListView.setOnItemClickListener( new Main77Activity.ListViewItemClickListener() );
        mListView.setOnItemLongClickListener(new Main77Activity.ListViewItemLongClickListener());
    ...
    public void updateListView()
    {
        ...
        mFriendListAdapter = new FriendListViewAdapter77(this, mFriendArrayList);
        ...
        for(int i=0; i<mFriendList.size(); i++) {
            ...
            if(mFriendList.get(i).getIsFinish().equals("T")&& mFriendList.get(i).getIsFinish_2().equals("F")){
            ...
            }else if(mFriendList.get(i).getIsFinish().equals("F")&& mFriendList.get(i).getIsFinish_2().equals("F") && compare1<0){
                item.setId(info.getId());
                item.setIsHoney(info.getIsHoney());
                item.setIsFast(info.getIsFast());
                item.setIsFinish(info.getIsFinish());
                ...
                mFriendArrayList.add(item);
            }else if(mFriendList.get(i).getIsFinish().equals("F")&& compare1>=0){
        ...
        alt_bld.setCancelable(false)
                .setPositiveButton("네", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        AlarmUtil.unregisterAlarm(Main77Activity.this, mSelAlarmId);
                        updateListView();
                        mSelItem = null;
                    }
                })
