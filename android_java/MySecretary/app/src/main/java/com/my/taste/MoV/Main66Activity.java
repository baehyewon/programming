...
import com.my.taste.dap.FriendListViewAdapter66;
...
public class Main66Activity extends Activity implements View.OnClickListener{

    private String LOG_TAG = "Main66Activity";
    ...
    private FriendListViewAdapter66 mFriendListAdapter = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtResult.setText("" +Nickname + "님의 긴급업무");
        ...
        mListView.setOnItemClickListener( new Main66Activity.ListViewItemClickListener() );
        mListView.setOnItemLongClickListener(new Main66Activity.ListViewItemLongClickListener());
    ...
    public void updateListView()
    {
        ...
        for(int i=0; i<mFriendList.size(); i++) {
            ...
            if(mFriendList.get(i).getIsFast().equals("T")) {
        ...
        mFriendListAdapter = new FriendListViewAdapter66(this, mFriendArrayList);
        ...
        alt_bld.setCancelable(false)
                .setPositiveButton("네", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        AlarmUtil.unregisterAlarm(Main66Activity.this, mSelAlarmId);
                        updateListView();
                        mSelItem = null;
                    }
                })
