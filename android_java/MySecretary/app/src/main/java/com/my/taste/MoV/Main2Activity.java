...
import com.my.taste.dap.FriendListViewAdapter2;
...
public class Main2Activity extends Activity implements View.OnClickListener{
    private String LOG_TAG = "Main2Activity";
    ...
    private FriendListViewAdapter2 mFriendListAdapter = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtResult.setText("" +Nickname + "님의 진행업무");
        ...
        mListView.setOnItemClickListener( new Main2Activity.ListViewItemClickListener() );
        mListView.setOnItemLongClickListener(new Main2Activity.ListViewItemLongClickListener());
    ...
    public void updateListView()
    {
        ...
        mFriendListAdapter = new FriendListViewAdapter2(this, mFriendArrayList);
        ...
        alt_bld.setCancelable(false)
                .setPositiveButton("네", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        AlarmUtil.unregisterAlarm(Main2Activity.this, mSelAlarmId);
                        updateListView();
                        mSelItem = null;
                    }
                })
