...
public class FriendListViewAdapter3 extends BaseAdapter /*implements CompoundButton.OnCheckedChangeListener*/ /*View.OnClickListener*/{
...
//        public TextView mTxtId;
    ...
    public FriendListViewAdapter3(Context context, ArrayList<FriendListViewItem> arrays){
...
//
        ...
        if (FriendArrayList.get(position).getIsFinish().equals("T")&& FriendArrayList.get(position).getIsFinish_2().equals("F")){
            ...
            viewHolder.mlList.setVisibility(View.GONE);
