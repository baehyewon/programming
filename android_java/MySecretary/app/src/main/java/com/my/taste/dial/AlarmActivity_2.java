...
import com.my.taste.AlarmUtil_2;
import com.my.taste.R;

public class AlarmActivity_2 extends Activity implements View.OnClickListener{
    ...
    protected void onResume() {
        ...
        if(intent != null)
        {
            ...
            AlarmUtil_2.unregisterAlarm(this, intentAlarmId);
        }
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId())
        {
            case R.id.aa_btn_ok:
                ...
                AlarmUtil_2.setSms_2(this, intentAlarmId, intentName, intentPhone, intentMessage, year, month-1, day, intentWill );
*/
                /*
